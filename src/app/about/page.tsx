...
import { gsap } from "gsap"; // Updated Import
    ...
    <div className="min-h-screen pt-24 px-6 max-w-5xl mx-auto">
      ...
      <div className="grid gap-12">
        <section className="about-content space-y-4">
          <h2 className="text-2xl flex items-center gap-2 font-bold text-foreground">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            Mera vision "NERA" jaise smart hardware aur "ShadowTrace" jaise defensive tools banana hai.
          </p>
        </section>
        ...
        <section className="about-content grid md:grid-cols-2 gap-6">
          <div className="p-6 border border-emerald-500/20 bg-emerald-500/5 rounded-xl">
            ...
            <p className="text-sm text-muted-foreground italic">"Loyalty and care for everyone—protecting the future."</p>
          </div>
          <div className="p-6 border border-emerald-500/20 bg-emerald-500/5 rounded-xl">
            <h3 className="flex items-center gap-2 font-bold mb-2 text-foreground">
              <Award className="text-emerald-500" /> Focus
            </h3>
            <p className="text-sm text-muted-foreground italic">Threat Intelligence & Malware Analysis.</p>
          </div>
        </section>
      </div>
    </div>
