  ...
  return (
    <div className="min-h-screen pt-24 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {guides.map((g, i) => (
          <div key={i} className="p-6 rounded-2xl border border-border bg-card hover:border-emerald-500/50 transition-all group">
            <div className="flex justify-between items-start mb-4">
              <Book className="text-emerald-500" />
              <span className="text-[10px] uppercase border px-2 py-1 rounded tracking-widest">{g.type}</span>
            </div>
